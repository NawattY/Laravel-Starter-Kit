...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('/themes/backend/assets/AdminLTE/plugins/iCheck/square/blue.css') }}">
...
<!-- iCheck -->
<script src="{{ asset('/themes/backend/assets/AdminLTE/plugins/iCheck/icheck.min.js') }}"></script>
<script>
    $(function () {
        $('input').iCheck({
